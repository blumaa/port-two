...
const WebSocketLogo = () => {
  ...
  let capeBottom = useRef(null);
  let capeTop = useRef(null);
  ...
  useEffect(() => {
    ...
    flap.add([
        waveSVG(capeBottom.current, {taperEnd: 80, invertFlow:false, taperStart:2, loose:true, length:120, angle:-52, magnitude:10, phase:110, duration:2, start:6, end:14, repeat:10}),
        ...
        waveSVG(capeTop.current, {loose:true, angle: 70, length:120, magnitude:10, phase:20, duration:2, start:2, end:9, repeat:10})
    ]);
  ...
  return (
    ...
    >
      <g>
        <path
          fill="#010101"
          d="M48.173,155.568c-10.389,4.887-37.886,26.886-43.182,33.404c-5.5,6.518-7.129-3.666-1.426-20.572
        ...
        <path
          fill="#010101"
          d="M197.067,342.348c1.833,10.999,0.204,11.814-11.202,13.24c-11.407,1.426-19.758-2.852-22.813-5.703
        ...
        <path
          fill="#010101"
          d="M210.511,30.911c-1.223-7.74,0-23.018,1.629-25.461c5.093-6.926,31.979-7.74,37.683,0.407
        ...
        <path
          fill="#010101"
          d="M270.395,322.59c12.425,8.963,21.998,10.592,28.312,13.851c6.314,3.26,4.685,9.574-5.907,11.407
        ...
        <g>
          <g>
            <path
              fill="#8AC640"
              d="M226.806,51.28c-22.405,19.351-65.791,24.646-130.155,49.496c-16.499,6.314-60.495,25.257-71.087,45.015
            ...
            <path
              fill="#8AC640"
              d="M226.806,51.28C173.033,70.019,119.87,74.704,57.339,113.201c-14.869,9.166-46.237,29.941-52.348,69.661
          ...
          <path
            fill="#010101"
            d="M295.448,162.9c0,0-3.87,13.24-11.61,17.518c0,0-5.703,2.037-17.109-4.277
          ...
          <path
            fill="#010101"
            d="M212.344,34.781c0,0-0.814,10.389-2.24,16.906c-0.204,1.223-6.314,1.833-10.796,3.667
          ...
          <path
            fill="#F0EFEF"
            d="M214.381,34.781c0,0,0,5.907-0.611,11.61c-0.203,2.648-0.407,4.277-0.814,6.314
          ...
          <path
            fill="#010101"
            d="M212.344,34.781c0,0-0.204,3.667-0.814,7.944c2.647,2.647,6.11,6.314,8.759,8.555
          ...
          <path
            fill="#010101"
            d="M230.88,50.261c-2.445,0-5.297-0.203-7.537-0.611c-1.019-0.203-2.037-0.814-2.852-1.222
          ...
          <path
            fill="#010101"
            d="M230.88,3.006c-13.443,0-16.092,3.666-19.962,7.74c-0.814,1.018-0.204,7.129,1.223,20.165h1.833
          ...
          <path
            fill="#010101"
            d="M295.448,163.511c0,0-3.87,12.425-11.406,16.702c-1.63-0.814-1.426-2.036-2.852-3.87
          ...
          <path
            fill="#010101"
            d="M268.969,73.482c0,0,12.832-3.056,21.591,5.296c8.759,8.555,8.147,19.146,5.5,25.664
          ...
          <path
            fill="#F0EFEF"
            d="M264.284,79.185c0,0,14.869-7.536,23.628,1.019c8.758,8.555,6.313,17.924,3.666,24.442
          ...
          <path
            fill="#010101"
            d="M221.306,66.353c-1.222-1.63-7.536-9.777-19.554-13.036c-3.463-1.019-5.703,1.833-9.165,3.87
          ...
          <path
            fill="#8AC640"
            d="M221.714,66.353c-6.519-2.241-5.5-9.777-19.962-10.999c-2.852-0.204-4.685,2.036-6.722,3.462
          ...
          <path
            fill="#010101"
            d="M260.007,69.612c0,0,0-2.241-0.204-4.277c0-0.407-1.629-1.426-1.629-1.833l-0.407-0.408
          ...
          <path
            fill="#8AC640"
            d="M259.192,68.593c0,0,1.222-1.019,0.814-1.223c2.24-1.222,5.296-2.647,6.722,1.223
          ...
          <path
            fill="#010101"
            d="M189.939,63.501c0,0,11.61,4.073,21.387,3.462c9.777-0.814,26.479-1.629,35.441,3.667
          ...
          <path
            fill="#010101"
            d="M268.562,173.492c0,0,12.629,45.219-2.24,64.162c0,0,2.24,8.758-2.852,18.128
          ...
          <path
            fill="#F0EFEF"
            d="M264.896,171.658c3.259,20.776,10.795,51.533-2.852,66.605c0.61,2.852,1.018,6.926,0.203,11.61
          ...
          <path
            fill="#F0EFEF"
            d="M189.939,63.501c0,0,4.481,1.426,9.369,1.833c4.889,0.407,10.185,0,14.869-0.204
          ...
          <path
            fill="#010101"
            d="M266.524,154.752c0,0,0.407,7.333,0.407,9.166c0,2.037,1.63,8.147,1.833,10.999
          ...
          <path
            fill="#F0EFEF"
            d="M262.044,155.364c0,5.092,0.814,8.759,1.426,12.018c1.018,5.907,2.647,9.777,2.647,13.647
          ...
          <path
            fill="#010101"
            d="M242.489,181.639c0,0-10.795-24.035-43.182-16.905c-7.739,21.794-18.128,46.848-11.406,73.938
          ...
          <path
            fill="#F0EFEF"
            d="M242.489,181.639c-0.61-2.24-8.758-24.238-38.904-17.721c-17.72,47.256-11.202,66.81-8.555,75.364
          ...
          <path
            fill="#010101"
            d="M192.179,148.846c0,0,5.5,0.203,10.389,1.833c4.685,1.629,4.685,2.647,6.518,4.685s6.314,5.092,5.5,8.147
          ...
          <path
            fill="#010101"
            d="M197.272,347.033l-0.611,5.093c0,0-1.833,2.24-15.48,2.037c-13.851-0.204-17.517-4.481-18.739-6.722
          ...
          <path
            fill="#010101"
            d="M226.806,336.645c0,2.24-0.204,2.24-0.204,4.481c2.444,1.833,8.556,2.852,20.165,2.647
			c16.906-0.407,32.59,5.093,51.736,1.833l0.204-3.666l-1.833-0.203l-67.828-5.5L226.806,336.645z"
          />
          <path
            fill="#010101"
            d="M241.675,343.774c1.63,0,3.259,0,5.092,0c11-0.407,21.388,2.037,32.59,2.648
			c5.907-0.204,13.24-1.63,12.629-5.907l-57.847-4.889C230.676,339.496,233.323,342.755,241.675,343.774z"
          />
          <path
            fill="#010101"
            d="M175.273,258.022c1.833,1.222,14.258,8.555,34.423,7.536c-0.408,3.87-0.204,11.407-9.166,24.646
          ...
          <path
            fill="#010101"
            d="M194.216,92.017c14.462-19.351,2.24-34.83-20.979-30.146c-9.37,1.833-18.739,8.352-19.351,20.165
          ...
          <path
            fill="#F0EFEF"
            d="M191.364,90.795c0.814-1.223,2.24-3.87,2.852-4.889c0.204-0.204,2.444,3.666,2.648,3.463
          ...
          <path
            fill="#010101"
            d="M279.968,94.054c-0.611,7.74-6.314,3.87-9.369,2.444c-6.111-2.648-12.222-4.481-19.351-4.481
          ...
          <path
            fill="#0A1825"
            d="M187.291,171.658c1.629,1.019,3.666,1.63,5.906,3.463c0,0-1.833,0-2.647-0.814
			C189.531,173.696,187.494,171.863,187.291,171.658L187.291,171.658z"
          />
          <path
            fill="#F0EFEF"
            d="M246.156,10.135c-0.611-1.833-5.093-5.093-15.48-5.093c-11.203,0-14.462,3.463-14.665,5.296
          ...
          <path
            fill="#010101"
            d="M224.769,261.892c0,0,10.796,4.685,37.479,0.611c0,0-7.536,37.886-4.073,56.828
          ...
          <path
            fill="#8AC640"
            d="M222.528,265.355c-1.426,2.037,0.203,9.776,2.24,17.313c2.037,7.536,6.519,12.018,7.537,24.442
          ...
          <path
            ...
            d="M229.454,328.294c3.462,1.629,8.555,2.852,12.425,2.852
          ...
          <path
            ...
            fill="#010101"
            enable-background="new    "
            d="M283.431,345.811c3.259-1.019,5.5-4.685,2.852-8.147
          ...
          <path
            ...
            fill="#010101"
            enable-background="new    "
            d="M221.917,273.298c4.685,1.63,11.814,2.037,17.925,1.833
          ...
          <path
            ...
            fill="#010101"
            enable-background="new    "
            d="M222.324,283.483c4.686,1.63,11.814,2.037,17.925,1.833
          ...
          <path
            fill="#010101"
            fill-opacity="0"
            d="M224.769,261.892c0,0,17.721,6.314,37.683,2.037c0,0-7.74,36.46-4.277,55.199
          ...
          <path
            fill="#010101"
            fill-opacity="0"
            d="M224.769,261.892c0,0,17.721,6.11,37.683,1.833c0,0-7.74,36.664-4.277,55.403
			c0,0,3.462,4.888,29.127,14.258c0,0,11.406,2.852,10.999,8.555c0,0,0.407,1.223-13.443,0.814
          ...
          <path
            fill="#010101"
            d="M208.881,140.699c0,1.426,15.888,9.369,24.646,10.999c8.759,1.629,27.091,0,29.942-0.611l-0.408,2.852
			c0,0-21.794,3.259-38.496-1.222c-16.703-4.481-14.869-5.5-14.869-5.5L208.881,140.699z"
          />
          <g>
            <path
              fill="#F0EFEF"
              d="M174.865,314.443c2.444,1.223,11.203,3.463,16.906,2.241c0.814-0.204,0-14.055,2.241-20.369
            ...
            <path
              fill="#F0EFEF"
              d="M188.513,327.276c1.426,0.407,2.444,2.036,2.852,1.019c0.814-1.834-1.426-5.296-1.63-7.74
          ...
          <path
            fill="#010101"
            d="M190.753,62.686c6.722,3.87,16.092,2.852,19.554,2.648c0.815,0,8.963-1.426,9.37-1.223
          ...
          <path
            fill="#010101"
            d="M260.007,66.556c1.222,0.814,9.166,3.87,12.629,7.536c3.055,3.26,1.426,3.056,0.814,2.241
			c-0.814-1.019-7.129-5.296-9.573-6.314s-5.5-2.852-5.5-3.259S260.007,66.556,260.007,66.556z"
          />
          <path
            fill="#F0EFEF"
            d="M189.734,151.086c5.907-0.407,12.018,1.019,15.888,5.092c2.037,2.037,5.296,4.277,4.889,6.314
        ...
        <path
          ...
          fill="#010101"
          enable-background="new    "
          d="M137.795,104.442c-18.332,7.333-64.977,30.554-78.216,37.683
        ...
        <path
          ...
          fill="#010101"
          enable-background="new    "
          d="M181.384,258.226c9.369-18.739,9.573-36.664,9.369-57.644
        ...
        <path
          fill="#010101"
          d="M41.654,159.437c11.61-8.351,71.698-40.329,86.16-44.811c14.461-4.685,9.98-10.185,9.98-10.185
        ...
        <path
          ...
          fill="#010101"
          enable-background="new    "
          d="M212.751,100.572c-4.685-1.833-8.351,3.667-7.129,8.963
        ...
        <path
          ...
          fill="#010101"
          enable-background="new    "
          d="M241.064,187.342c-0.407,15.276,3.056,37.886,4.481,48.682
        ...
        <path
          ...
          fill="#010101"
          enable-background="new    "
          d="M213.974,44.762c2.852,6.313,6.314,9.165,11.813,10.999
        ...
        <path
          fill="#8AC640"
          d="M213.362,59.427c6.722,2.852,19.758,5.907,23.424,6.722s9.573-2.852,12.425-4.685
        ...
        <path
          fill="#010101"
          d="M181.791,249.67c-0.407-0.407,0.407-0.814,0-0.814c-2.647,0-6.314-2.037-8.352-4.889
        ...
        <path
          ...
          fill="#010101"
          enable-background="new    "
          d="M276.302,118.7c0.611,3.055,2.24,8.962,5.499,11.813
